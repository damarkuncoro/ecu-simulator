...
var ECUDiagnosticApp = /** @class */ (function () {
    function ECUDiagnosticApp() {
        this.isInitialized = false;
    }
    ECUDiagnosticApp.prototype.initialize = function () {
    ...
    ECUDiagnosticApp.prototype.start = function () {
        if (!this.isInitialized) {
    ...
    ECUDiagnosticApp.prototype.stop = function () {
        console.log("Stopping ECU Diagnostic Dashboard...");
        this.isInitialized = false;
    };
    return ECUDiagnosticApp;
}());
