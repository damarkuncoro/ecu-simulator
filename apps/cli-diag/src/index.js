...
var transport_abstract_1 = require("@ecu/transport-abstract");
var logger_1 = require("@ecu/logger");
var log = new logger_1.Logger('cli-diag');
function main() {
            ...
            switch (_c.label) {
                case 0:
                    log.info('ECU Simulator CLI starting', {
                        transport: (_a = process.env['ECU_TRANSPORT']) !== null && _a !== void 0 ? _a : 'tcp',
                        profile: (_b = process.env['ECU_PROFILE']) !== null && _b !== void 0 ? _b : 'generic',
                    });
                    return [4 /*yield*/, (0, transport_abstract_1.createTransport)()];
                case 1:
                    transport = _c.sent();
                    _c.label = 2;
                case 2:
                ...
                case 4:
                    err_1 = _c.sent();
                    log.error('Failed to connect', { error: String(err_1) });
                    process.exit(1);
                    return [3 /*break*/, 5];
